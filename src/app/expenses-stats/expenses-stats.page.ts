import { Component, createComponent, OnDestroy, OnInit } from '@angular/core';
import { CommonModule } from '@angular/common';
import { FormsModule } from '@angular/forms';
import { IonContent, IonHeader, IonSpinner, IonTitle, IonToolbar, IonLabel } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent,  IonLabel, IonTitle, CommonModule, FormsModule]
})
export class ExpensesStatsPage implements OnInit, OnDestroy {
