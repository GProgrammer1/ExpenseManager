...
deleteData(item: Expense | Income) {
  ...
  async bindData() {
    ...
    this.expenses$ = this.firestoreService.expenses$;

    this.incomes$ = this.firestoreService.incomes$;
    ...
    const formattedTimestam = this.formatTimestamp(timestamp);
    console.log("Formatted timestamp:", formattedTimestam);
